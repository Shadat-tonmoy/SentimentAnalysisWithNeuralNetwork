...
class SentimentNetwork:
    ...
    def train(self, training_reviews, training_labels):
        ...
        for i in range(len(training_reviews)):
            ...
            print("Hidden Layer input ",layer_1,"\nShape ",layer_1.shape)

            # Output layer
            layer_2 = self.sigmoid(layer_1.dot(self.weights_1_2))
            print("Output Layer input ", layer_2, "\nShape ", layer_2.shape)
            ...
            print("Output layer error", layer_2_error, "\nShape ", layer_2_error.shape)
            layer_2_delta = layer_2_error * self.sigmoid_output_2_derivative(layer_2)
            print("Output layer error term", layer_2_delta, "\nShape ", layer_2_delta.shape)


            # Backpropagated error
            layer_1_error = layer_2_delta.dot(self.weights_1_2.T)  # errors propagated to the hidden layer
            print("Hidden layer error", layer_1_error, "\nShape ", layer_1_error.shape)
            layer_1_delta = layer_1_error  # hidden layer gradients - no nonlinearity so it's the same as the error
            print("Hidden layer error term", layer_1_delta, "\nShape ", layer_1_delta.shape)
